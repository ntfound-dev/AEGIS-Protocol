...
import { idlFactory } from './insurance_vault.did.js';
export { idlFactory } from './insurance_vault.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_INSURANCE_VAULT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./insurance_vault.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the insurance_vault canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./insurance_vault.did.js")._SERVICE>}
 */
export const insurance_vault = createActor(canisterId);
