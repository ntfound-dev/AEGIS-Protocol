...
import { idlFactory } from './event_factory.did.js';
export { idlFactory } from './event_factory.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EVENT_FACTORY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./event_factory.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the event_factory canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./event_factory.did.js")._SERVICE>}
 */
export const event_factory = createActor(canisterId);
