...
import { idlFactory } from './event_dao.did.js';
export { idlFactory } from './event_dao.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EVENT_DAO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./event_dao.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the event_dao canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./event_dao.did.js")._SERVICE>}
 */
export const event_dao = createActor(canisterId);
