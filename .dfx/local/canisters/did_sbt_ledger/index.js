...
import { idlFactory } from './did_sbt_ledger.did.js';
export { idlFactory } from './did_sbt_ledger.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DID_SBT_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./did_sbt_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the did_sbt_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./did_sbt_ledger.did.js")._SERVICE>}
 */
export const did_sbt_ledger = createActor(canisterId);
